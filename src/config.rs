...
impl Default for Config {
    fn default() -> Self {
        let default_types = indexmap! {
            "feat" => "add a new feature in the code",
            "sec" => "patch a security issue",
            "fix" => "patch a code bug",
            "perf" => "enhance the performance, without adding a new feature",
            "refactor" => "refactor the code",
            "test" => "add, update or remove tests only",
            "docs" => "update the documentation only",
            "style" => "update the style, like running clang-format or changing headers",
            "deps" => "add, update or remove external dependencies",
            "build" => "update the build system or build scripts",
